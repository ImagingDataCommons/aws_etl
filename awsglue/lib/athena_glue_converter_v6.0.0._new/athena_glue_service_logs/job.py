...
from athena_glue_service_logs.cloudtrail2 import CloudTrailRawCatalog2, CloudTrailConvertedCatalog2
...
class JobRunner:
    ...
    SERVICE_DEFINITIONS = {
        ...
        'cloudtrail2': [CloudTrailRawCatalog2, CloudTrailConvertedCatalog2],
